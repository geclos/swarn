...
export function printReport(stats: RunStats): void {
  ...
  console.log(`  Tasks:         \x1b[32m${stats.tasksCompleted} completed\x1b[0m, \x1b[31m${stats.tasksFailed} failed\x1b[0m`)
  ...
  console.log(`  Tokens:        ${stats.totalTokens.input} in / ${stats.totalTokens.output} out`)
